        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="content">
                        <div class="download-sample"> <a href="{{ route('download-sample',['filename' => 'companies_sample_csv_format.csv']) }}">Donwload Sample</a> </div>
                        <form action="{{ route('import-store') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                            {!! csrf_field() !!}
